# ASAM OpenODD® v1.0.0 — B.3 YAML ISO 34503

> **Source**: https://publications.pages.asam.net/standards/ASAM_OpenODD/ASAM_OpenODD/latest/specification/11_annexes/11_e_iso34503_03_yaml.html
...
The listing in [Code 216](#code-taxonomy-yaml) shows a YAML representation of the taxonomy defined in ISO 34503 [[4](../bibliography.html#bib-iso34503)].

Code 216. Definition of a taxonomy (YAML)
...
TAXONOMY:
  ...
  environmental_conditions:
    ...
    weather:
      wind:
        no_wind:
          wind_speed: "<= 0 m/s"
        calm: # <0,2 m/s
          wind_speed: "[0 .. 0.2] m/s"
        light_air: # 0,3 – 1,5 m/s
          wind_speed: "[0.2 .. 1.5] m/s"
        light_breeze: # 1,6 – 3,3 m/s
          wind_speed: "[1.5 .. 3.3] m/s"
        gentle_breeze: # 3,4 – 5,4 m/s
          wind_speed: "[3.3 .. 5.4] m/s"
        moderate_breeze: # 5,5 – 7,9 m/s
          wind_speed: "[5.4 .. 7.9] m/s"
        fresh_breeze: # 8,0 – 10,7 m/s
          wind_speed: "[7.9 .. 10.7] m/s"
        strong_breeze: # 10,8 – 13,8 m/s
          wind_speed: "[10.7 .. 13.8] m/s"
        near_gale: # 13,9 – 17,1 m/s
          wind_speed: "[13.8 .. 17.1] m/s"
        gale: # 17,2 – 20,7 m/s
          wind_speed: "[17.1 .. 20.7] m/s"
        strong_gale: #  20,8 - 24,4 m/s
          wind_speed: "[20.7 .. 24.4] m/s"
        storm: # 24,5 – 28,4 m/s
          wind_speed: "[24.4 .. 28.4] m/s"
        violent_storm: # 28,5 – 32,6 m/s
          wind_speed: "[28.4 .. 32.6] m/s"
      ...
      rain:
        ...
        rainfall_intensity:
          no_rain:
            rainfall_rate: "<= 0 mm/h"
          light_rain: # < 2,5 mm/h
            rainfall_rate: "[0 .. 2.5] mm/h"
    ...
    illumination:
      ...
      cloudiness:
        clear: # 0 – 1 oktas
          cloudiness_rate: "<= 1 Oktas"
        partly_cloudy_few_clouds: # 1 – 2 oktas
          cloudiness_rate: "[1 .. 2] Oktas"
        partly_cloudy_scattered_clouds: # 3 – 4 oktas
          cloudiness_rate: "[3 .. 4] Oktas"
        partly_cloudy_broken_clouds: # 5 – 7 oktas
          cloudiness_rate: "[5 .. 7] Oktas"
        overcast: # 8 oktas
          cloudiness_rate: ">= 8 Oktas"
