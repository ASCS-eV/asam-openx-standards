...
Further informative content is shown in [Table 2](#tab-informative-text-components).
...
| First to last annex | Annexes can be normative or informative. The annex heading contains the indication "(normative)" or "(informative)". |
...
`data types` are given according to the standard IEEE 754 [[1](../bibliography.html#bib-ieee754_2019)].
...
Geographic positions are stated in the unit defined by the spatial coordinate system, for example, in accordance with EPSG:4326 WGS 84 [[2](../bibliography.html#bib-epsg4326)].
...
[Figure 2](#fig-ac4e473f-7a60-447f-8394-b7f71f6e2c06) shows the basic principles of UML modeling and its notation within ISO geographic information standards.
See also ISO TS 19103 [[4](../bibliography.html#bib-isots19103)].
...
![img](../_images/00_preface/uml_attributes.png)
