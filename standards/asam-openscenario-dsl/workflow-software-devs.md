# ASAM OpenSCENARIO® DSL v2.2.0 — B.10 Workflows for software developers

> **Source**: https://publications.pages.asam.net/standards/ASAM_OpenSCENARIO/ASAM_OpenSCENARIO_DSL/latest/annexes/workflows/workflow_software_devs.html
...
* [Section B.10.2](#sec-up-workflow-1333)  
...
Software developers have the need to process scenario information or simulation results from different software or hardware releases.
They also need to produce comparison charts to provide trend and gap analysis.
ASAM OpenSCENARIO must allow them to do so.

### B.10.2.3 Workflow diagram

![Processing and comparing results](../_images/diag-6464c7b4cdeb343b86bfe4b6238387ba1a99a404.png)

Figure 47. Processing and comparing results

### B.10.2.4 Steps for processing and comparing results

Software developers can use ASAM OpenSCENARIO to produce comparison charts or to provide trend and gap analysis following these steps:
...
9. Produce comparison charts.+
   This creates your *first wanted deliverable*.
