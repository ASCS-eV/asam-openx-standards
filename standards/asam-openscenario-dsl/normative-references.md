...
The following documents are referred to in the text in such a way that some or all of their content constitutes some of the requirements set out in this document.
...
[ASAM OpenSCENARIO® DSL BS 2.2.0 Specification, 2026-03-19](index.html) is designed to support a set of standards aimed at scenario-based approaches and methodologies for the verification of *Automated Driving Systems* (ADS).

Among them are:

* ISO 34502 (in development)  
  "Scenario based safety evaluation framework for ADS"
* ISO 21448 [[7](bibliography.html#bib-iso21448)]

ASAM OpenSCENARIO is designed to be ready to support ODD definitions based on:

* BSI PAS 1883 [[8](bibliography.html#bib-pas1883)]
* ISO 34503 [[9](bibliography.html#bib-iso34503)]
* SAE J3259 (in development)

The standard is compatible with:

* ISO 8601 [[10](bibliography.html#bib-iso8601)]
* ISO 8855 [[11](bibliography.html#bib-iso8855)]
* SAE J3016 (2021) [[12](bibliography.html#bib-saeJ3016)]